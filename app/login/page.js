  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.logo}>
          <div className={styles.logoIcon}>
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
              <path d="M14 2L26 8.5V19.5L14 26L2 19.5V8.5L14 2Z" fill="url(#g1)" stroke="rgba(167,139,250,0.3)" strokeWidth="0.5"/>
        ...
        <p className={styles.sub}>Sign in to access your private gallery</p>
